variable "domain_name" {
  description = "Base domain students registered (e.g., dawgs-armageddon-growl.com)."
  type        = string
  default     = "dawgs-armageddon-growl.com"
}

variable "app_subdomain" {
  description = "App hostname prefix (e.g., app.dawgs-armageddon-growl.com)."
  type        = string
  default     = "app"
}
